...
> *Code Intelligence, Architecture Cockpit & Deterministic AI Context Packer* direto na barra lateral do Google Chrome.
...
1. No canto superior direito da tela de extensões, ative a chave seletora **"Modo do desenvolvedor"** (*Developer mode*).
...
2. Clique no ícone de alfinete (Fixar / *Pin*) ao lado de **MRCP Engine**.
